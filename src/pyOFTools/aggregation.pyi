...
@overload
def sum(
    values: pybFoam.pybFoam_core.scalarField,
    mask: pybFoam.pybFoam_core.boolList | None = None,
    group: pybFoam.pybFoam_core.labelList | None = None,
    *,
    scalingFactor: pybFoam.pybFoam_core.scalarField | None = None,
) -> scalarAggregationResult: ...
@overload
def sum(
    values: pybFoam.pybFoam_core.vectorField,
    mask: pybFoam.pybFoam_core.boolList | None = None,
    group: pybFoam.pybFoam_core.labelList | None = None,
    *,
    scalingFactor: pybFoam.pybFoam_core.scalarField | None = None,
